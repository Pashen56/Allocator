#ifndef DATA_STRUCTURES_CPP_MEMORY_WITH_DESCRIPTOR_DEALLOCATION_H
#define DATA_STRUCTURES_CPP_MEMORY_WITH_DESCRIPTOR_DEALLOCATION_H
...
class allocator_descriptor final :
...
public:
    ...
    allocator_descriptor(
        allocator_descriptor const& other) = delete;

    allocator_descriptor& operator=(
        allocator_descriptor const& other) = delete;

    ~allocator_descriptor() noexcept;
...
#endif //DATA_STRUCTURES_CPP_MEMORY_WITH_DESCRIPTOR_DEALLOCATION_H
