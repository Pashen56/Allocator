#ifndef DATA_STRUCTURES_CPP_MEMORY_WITH_DOUBLE_SYSTEM_DEALLOCATION_H
#define DATA_STRUCTURES_CPP_MEMORY_WITH_DOUBLE_SYSTEM_DEALLOCATION_H
...
class allocator_double_system final :
...
public:
    ...
    explicit allocator_double_system(
        size_t memory_size,
    ...
    allocator_double_system(
        allocator_double_system const& other) = delete;

    allocator_double_system& operator=(
        allocator_double_system const& other) = delete;

    ~allocator_double_system() noexcept;
...
#endif //DATA_STRUCTURES_CPP_MEMORY_WITH_DOUBLE_SYSTEM_DEALLOCATION_H
